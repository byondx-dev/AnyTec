      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center relative z-10">
        ...
        <div className="flex justify-center py-12 lg:py-0">
          <div className="relative w-64 h-64 flex items-center justify-center">
             ...
             {/* Center AI Chip */}
             <div className="w-20 h-20 rounded-2xl bg-[#0f1420] border border-white/10 flex items-center justify-center shadow-[0_0_40px_rgba(16,185,129,0.1)] relative z-10">
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-[92vh] flex items-center pt-20">
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Abstract Visual */}
          <div className="order-1 lg:order-2 h-[450px] lg:h-[650px] relative flex items-center justify-center">
            <div className="absolute inset-0 bg-gradient-to-tr from-accent/5 to-transparent rounded-full blur-[100px]" />
            <PixelVisual />
          </div>
        </div>
      </section>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center max-w-3xl relative z-10">
          <Reveal>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">Optimiere Betrieb, Sicherheit und Skalierung — <span className="text-muted/50">ohne IT-Stress.</span></h2>
      ...
      <section className="py-40 relative overflow-hidden bg-[#0b0f19] text-white">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
           <Reveal>
             ...
             <Button size="lg" className="h-16 px-10 text-lg bg-accent text-black hover:bg-accent/90 shadow-[0_0_40px_rgba(16,185,129,0.3)] transition-all hover:scale-105" onClick={() => navigate('/kontakt')}>
                Erstgespräch buchen
             </Button>
           </Reveal>
        </div>
